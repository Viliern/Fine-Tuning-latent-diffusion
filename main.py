...
class ImageLogger(Callback):
    ...
    def on_validation_batch_end(self, trainer, pl_module, outputs, batch, batch_idx, dataloader_idx):
        ...
        if not self.disabled and pl_module.global_step > 0:
            # print('dadadadadadadadada', self.disabled, pl_module.global_step, batch_idx)
...
if __name__ == "__main__":
    ...
    opt, unknown = parser.parse_known_args(['-t=True',
                                            '--base=configs/latent-diffusion/my_train2.yaml',
                                            '--gpus=1',
                                            '--scale_lr=False',
                                            '--num_nodes=1',
                                            '--check_val_every_n_epoch=1',
                                            '--val_check_interval=100',
                                            '--finetune_from=models/ldm/text2img-large/model.ckpt'])
    ...
    trainer = Trainer.from_argparse_args(trainer_opt, **trainer_kwargs, max_epochs=20)
