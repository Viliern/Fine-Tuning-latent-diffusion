...
#     processed = {}
#     processed["image"] = [tf(im) for im in examples["image"]]
#     processed["txt"] = examples["text"]
#     return processed
# def hf_dataset(
#     name,
#     image_transforms=[],
...
#     print("changing pil")
#     ds = ds.map(lambda x: {image_column: feature.decode_example(x[image_column])})
#     print("changing pil done")
#     # image_transforms = [instantiate_from_config(tt) for tt in image_transforms]
